        ...
        <div class="area-b">
            ...
            <header class="display-f justify-bt align-c content-body f-mont f-700 f-16">
                <div class="display-f justify-bt align-c header-inicio content-header-cad f-mont f-700 f-20">
                    <div>
                        <a href="./info-produto.php" class="display-f align-c">
                            ...
                            <div class="card">
                                <div class="label-titulo">
                                    <label class="display-f align-c justify-c f-mont f-900 f-36 color-label">
                                        <span class="material-icons-round m-r color-blue">monetization_on</span>
                                        Cadastro de produtos
                                    </label>
                                </div>
                                <form method="post" action="cadastrar-produto.php" enctype="multipart/form-data">
                                    <label class="f-mont f-500 f-18">Nome do Produto</label>
                                    <input class="f-mont f-500 f-14 input" type="text" id="nomeProduto" name="nomeProduto" placeholder="Digite o nome do produto">
                                    <br> <br>
                                    <label class="f-mont f-500 f-18">Descrição do Produto:</label>
                                    <textarea class="f-mont f-500 f-14 input" rows="5" cols="50" name="descProduto" id="descProduto" placeholder="Descreva brevemente sobre o produto"></textarea>
                                    <br> <br>
                                    <label class="f-mont f-500 f-18">Foto do Produto</label>
