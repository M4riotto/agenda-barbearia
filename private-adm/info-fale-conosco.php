...
<head>
    ...
    <link rel="stylesheet" href="../css/private-fale.css">
    ...
    <!-- - - - - - - - -| TÍTULO & ÍCONE HEAD | - - - - - - - - -->
    <title>Fale conosco | Duhel</title>
    ...
    <div>
        ...
        <div class="content-pagina">
            <div class="content-body">
                ...
                foreach ($listaContato as $linha) {
                    echo ("
                        <div class='card-fale animate_card'>
                            <div class='content-card'>
                                <div class='display-f align-c justify-c f-kanit f-900 f-18 m-b'>
                                <span class='material-icons m-r color-blue'>contact_mail</span>
                                 Email: " . $linha['emailContato'] . "</div>
                               
                                <div class='display-f align-c justify-c f-kanit f-900 f-18 m-t m-b'>
                                <span class='material-icons color-blue m-r'>article</span>
                                Texto: </div>
                                
                                <div class='display-f align-c justify-c f-kanit f-900 f-18 m-b'>" . $linha['textoContato'] . "</div>

                                <div class='m-t'>
                                    <a href='excluir.php?excContato=" . $linha['idContato'] . "'>
                                        <div class='f-kanit botao-excluir display-f justify-c align-c  m-t'>
