                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="app-search-box col">
                            <div class="display-f justify-bt align-c header-inicio content-header-list f-mont f-700 f-20">
                                ...
                                <a href="./form-cliente.php" class="display-f align-c justify-c">
                                    Cadastrar clientes
                                </a>
                            </div>
                        </div><!--//app-search-box-->
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="row g-3 mb-4 align-items-center justify-content-between">
                <div class="col-auto">
                    <p>
                        <?php
                        foreach ($contaCliente as $linha) {
                            echo ("<label class='f-kanit f-900 f-20 m-b color-grey-ligth'> Existe: " . $linha['Quantidade'] . " clientes cadastrados</label>");
                        }
                        ?>
                    </p>
                </div>
                    ...
                    <div class="page-utilities">
                        <div class="row g-2 justify-content-start justify-content-md-end">
                            ...
                            <div class="col-auto">
                                ...
                                <a id="cadastroMemb" class="btn app-btn-primary" href="./form-cliente.php" class="display-f align-c justify-c">
                                    Cadastrar cliente
                                </a>
                    ...
                    <div class="content-body ">
                        ...
                        foreach ($listacliente as $linha) {
                            ...
                            <div class='content-card'>
                                ...
                                " . $linha['nomeCliente'] . "</div>
                               
                                <div class='display-f align-c justify-c f-kanit f-900 f-18 m-b'>
                                <span class='material-icons-round m-r'>folder_shared</span>
                                CPF: " . $linha['cpfCliente'] . "</div>
                                                                                               
                                <div class='display-f align-c justify-c f-kanit f-900 f-18 m-b'>
                                <span class='material-icons-round m-r'>phone</span>
                                Celular: " . $linha['celularCliente'] . "</div>
                                  
                                <div class='m-t'>
                                    <a href='excluir.php?excCliente=" . $linha['idCliente'] . "'>
